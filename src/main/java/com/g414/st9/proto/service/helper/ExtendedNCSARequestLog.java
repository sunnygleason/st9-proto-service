...
/**
 */
public class ExtendedNCSARequestLog extends AbstractLifeCycle implements RequestLog
{
    ...
    public void log(Request request, Response response)
    {
        try
        {
            ...
            if (request.getHeader("X-User-ID") != null) {
                buf.append(request.getHeader("X-User-ID"));
            } else {
                buf.append("-");
            }
            ...
            if (request.getHeader("X-Session-ID") != null) {
                buf.append(request.getHeader("X-Session-ID"));
            } else {
                buf.append("-");
            }
            ...
            if (request.getHeader("X-Request-ID") != null) {
                buf.append(request.getHeader("X-Request-ID"));
            } else {
                buf.append("-");
            }
